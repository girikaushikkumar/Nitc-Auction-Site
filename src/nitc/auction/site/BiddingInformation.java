...
public class BiddingInformation extends javax.swing.JFrame {

    /**
     * Creates new form BiddingInformation
     */
    ...
    public void ShowDetails()
    {
        int Hprice=0;
            ...
            try {
                ...
                //Set table content
                PreparedStatement stt=con.prepareStatement("select * from product where seller_id='"+sellerId+"'");
    ...
    private void initComponents() {
        ...
        GoToFinalWinnerDetails = new javax.swing.JButton();
        ...
        jLabel9.setText("Final Winner Details");

        GoToFinalWinnerDetails.setBackground(new java.awt.Color(0, 0, 0));
        GoToFinalWinnerDetails.setFont(new java.awt.Font("Century", 1, 18)); // NOI18N
        GoToFinalWinnerDetails.setForeground(new java.awt.Color(255, 255, 255));
        GoToFinalWinnerDetails.setText("Check");
        GoToFinalWinnerDetails.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                GoToFinalWinnerDetailsMouseClicked(evt);
            }
        });
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(GoToFinalWinnerDetails)
                        .addGap(112, 112, 112))))
        );
        ...
        jLabel6.setText("Bidding Information");
...
//                tableModel.addRow(tableData);
    ...
    private void GoToFinalWinnerDetailsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_GoToFinalWinnerDetailsMouseClicked
        if(sts.getText().equals("Completed"))
        {
            FinalWinnerSellerSide fs = new FinalWinnerSellerSide();
            fs.ProductId = id.getText();
            fs.sellerId = sellerId;
            fs.setVisible(true);
            this.dispose();
        }
        else{
            JOptionPane.showMessageDialog(this, "Status should be Completed");
        }
    }//GEN-LAST:event_GoToFinalWinnerDetailsMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BiddingInformation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BiddingInformation().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton GoToFinalWinnerDetails;
